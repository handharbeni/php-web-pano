...
<body>
    ...
    <div id="container">
        <h1>Form Upload Galery</h1>

        <div id="body">
            <?php echo form_open_multipart('KhususAdmin/insertGalery/', array('id' => 'img')); ?>
            <p>Galery Image</p>
            ...
            <textarea name="desc" rows="5" placeholder="Your description here..."></textarea>
